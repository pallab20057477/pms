...
export default function ArchiveTasks() {
  ...
  const openAdd = () => {
    setForm({ name: "", due_date: "", description: "", assigned_to: "", status: "archive" });
    setSelected(null);
    setShowModal(true);
  };
  const openEdit = (row) => {
    ...
    <>
      <section className="content-header">
        ...
        <div className="header-title">
          <h1>Archive Tasks</h1>
          <small>Archive Tasks details</small>
        </div>
      </section>
            ...
            <div className="panel panel-bd lobidisable">
              ...
              <div className="panel-body">
                <div className="btn-group" style={{ marginBottom: 12 }}>
                  ...
                  <TableExportButtons tableId="tasksTable" filename="archive_tasks" />
                </div>
                ...
                <form className="form-horizontal" onSubmit={handleFormSubmit}>
                  <div className="modal-body">
                    <div className="row">
                      ...
                      <div className="col-md-8 form-row" style={{ display: 'flex', gap: '12px', paddingBottom: 16 }}>
                        <div style={{ flex: 1 }}>
                      ...
                      <div className="col-md-12 form-group" style={{ paddingBottom: 16 }}>
